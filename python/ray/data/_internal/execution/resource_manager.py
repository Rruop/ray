...
class ResourceManager:
    ...
    def _estimate_object_store_memory_usage(
        ...
        # 算子内部的 Object Store 使用量：正在运行的任务的待输出块，估算出每个 task 的 block 输出数量
        # mem_op_internal = obj_store_mem_pending_task_outputs = 正在运行任务尚未完成的输出块总的内存大小
        ...
        op_outputs_bytes = (
            ...
            # 算子外部输出队列（OpState 中）== 等于 下游算子外部输入队列
