...
DEFAULT_PROMETHEUS_HOST = "http://10.81.0.157:9090"
...
DEFAULT_GRAFANA_HOST = "http://10.81.0.157:3000"
...
DEFAULT_GRAFANA_IFRAME_HOST = "https://search-keling-ray-grafana.corp.kuaishou.com"
...
class MetricsHead(SubprocessModule):
    ...
    async def grafana_health(self, req) -> aiohttp.web.Response:
        ...
        grafana_iframe_host = os.environ.get(
            GRAFANA_IFRAME_HOST_ENV_VAR, DEFAULT_GRAFANA_IFRAME_HOST
        )
